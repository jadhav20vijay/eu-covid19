...
df_raw_population = spark.read.csv("abfss://raw@adlsg2covid19sa.dfs.core.windows.net/population", sep=r'\t', header=True)
...
df_dim_country = spark.read.csv("abfss://lookup@adlsg2covid19sa.dfs.core.windows.net/dim_country", sep=r',', header=True)
...
df_processed_population.write.format("com.databricks.spark.csv").option("header","true").option("delimiter", ",").mode("overwrite").save("abfss://processed@adlsg2covid19sa.dfs.core.windows.net/population")
